...
return [
    ...
    'If nothing is selected, then all' => 'Если ничего не выбрано, используются все элементы',
    'Rss' => 'Rss',
    'Settings' => 'Настройки',
    'Time zone which display date in feed' => 'Часовая зона с которой отображаются даты',
